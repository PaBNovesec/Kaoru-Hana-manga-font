**Bloomed Flower** is a self made Kaoru Hana manga font.

Curently no suport for serif I , so to acces it you need to use lowercase I letter. (If someone knows how fix this using Font Forge or any other programm/app,let me know)
